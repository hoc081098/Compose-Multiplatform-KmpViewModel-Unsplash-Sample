...
package com.hoc081098.compose_multiplatform_kmpviewmodel_sample.photo_detail.data.remote.response
...
internal data class CoverPhotoResponse(
  ...
  @SerialName(value = "user") val user: UnsplashUserResponse,
)

@Serializable
internal data class UnsplashUserResponse(
