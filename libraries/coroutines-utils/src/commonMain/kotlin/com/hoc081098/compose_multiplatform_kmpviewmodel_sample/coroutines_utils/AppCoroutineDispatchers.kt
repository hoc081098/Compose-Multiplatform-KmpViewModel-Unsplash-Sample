...
interface AppCoroutineDispatchers {
  /**
   * The companion object for the [AppCoroutineDispatchers] interface. This is provided so that it's possible to create
...
internal class RealAppCoroutineDispatchers : AppCoroutineDispatchers {
...
/**
 * @return an instance of [AppCoroutineDispatchers] that provides access to commonly used [CoroutineDispatcher]s.
 */
public fun AppCoroutineDispatchers(): AppCoroutineDispatchers = RealAppCoroutineDispatchers()
